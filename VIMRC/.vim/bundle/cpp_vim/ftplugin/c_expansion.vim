...
"
" Description:
" Expands various special expressions in c/cpp source files.
...
if exists("cpp_expansion_loaded")
    finish
endif
let cpp_expansion_loaded = 1

function! BudaCppExpand()
    ...
    while i < sz
        ...
        " container and type expansion
        let line = substitute(line, '@vi', 'vector<int>', 'g')
        let line = substitute(line, '@vd', 'vector<double>', 'g')
        let line = substitute(line, '@vs', 'vector<string>', 'g')
        let line = substitute(line, '@vll', 'vector<long long>', 'g')
        let line = substitute(line, '@vvi', 'vector< vector<int> >', 'g')
        let line = substitute(line, '@vvd', 'vector< vector<double> >', 'g')
        let line = substitute(line, '@vvs', 'vector< vector<string> >', 'g')
        let line = substitute(line, '@vvll', 'vector< vector<long long> >', 'g')

        let line = substitute(line, '@ll', 'long long', 'g')

        let line = substitute(line, '@pii', 'pair<int, int>', 'g')
        let line = substitute(line, '@pdd', 'pair<double, double>', 'g')
        let line = substitute(line, '@pss', 'pair<string, string>', 'g')

        let line = substitute(line, '@si', 'set<int>', 'g')
        let line = substitute(line, '@sd', 'set<double>', 'g')
        let line = substitute(line, '@ss', 'set<string>', 'g')
        let line = substitute(line, '@sll', 'set<long long>', 'g')

        let line = substitute(line, '@mii', 'map<int, int>', 'g')
        let line = substitute(line, '@mis', 'map<int, string>', 'g')
        let line = substitute(line, '@msi', 'map<string, int>', 'g')
        let line = substitute(line, '@mid', 'map<int, double>', 'g')
        let line = substitute(line, '@mdi', 'map<double, int>', 'g')
        let line = substitute(line, '@mss', 'map<string, string>', 'g')
        let line = substitute(line, '@mill', 'map<int, long long>', 'g')
        let line = substitute(line, '@mlli', 'map<long long, int>', 'g')
        let line = substitute(line, '@msll', 'map<string, long long>', 'g')
        let line = substitute(line, '@mlls', 'map<long long, string>', 'g')
        let line = substitute(line, '@mllll', 'map<long long, long long>', 'g')
